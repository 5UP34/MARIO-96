...
local VOICETABLE_MX = {
    ...
    [CHAR_SOUND_YAH_WAH_HOO] = {'mx-yah.ogg', 'mx-jump-wah.ogg', 'mx-wah-hoo.ogg'},
    [CHAR_SOUND_YAWNING] = 'mx-yawn.ogg',
}

local VOICETABLE_LUCAS = {
    [CHAR_SOUND_ATTACKED] = 'lucas-ahow.ogg',
    [CHAR_SOUND_COUGHING1] = 'lucas-cough1.ogg',
    [CHAR_SOUND_COUGHING2] = 'lucas-cough2.ogg',
    [CHAR_SOUND_COUGHING3] = 'lucas-cough3.ogg',
    [CHAR_SOUND_DOH] = 'lucas-doh.ogg',
    [CHAR_SOUND_DROWNING] = 'lucas-drown.ogg',
    [CHAR_SOUND_DYING] = 'lucas-die.ogg',
    [CHAR_SOUND_EEUH] = 'lucas-eeuh.ogg',
    [CHAR_SOUND_GROUND_POUND_WAH] = 'lucas-gp-wah.ogg',
    [CHAR_SOUND_HAHA] = 'lucas-haha.ogg',
    [CHAR_SOUND_HAHA_2] = 'lucas-haha.ogg',
    --[CHAR_SOUND_HELLO] = 'no-sound.ogg',
    [CHAR_SOUND_HERE_WE_GO] = 'lucas-star.ogg',
    [CHAR_SOUND_HOOHOO] = 'lucas-hoohoo.ogg',
    [CHAR_SOUND_HRMM] = 'lucas-hrmm.ogg',
    [CHAR_SOUND_IMA_TIRED] = 'lucas-tired.ogg',
    --[CHAR_SOUND_LETS_A_GO] = 'no-sound.ogg',
    [CHAR_SOUND_MAMA_MIA] = 'lucas-mamamia.ogg',
    [CHAR_SOUND_ON_FIRE] = 'lucas-fire.ogg',
    --[CHAR_SOUND_OOOF] = 'no-sound.ogg',
    --[CHAR_SOUND_OOOF2] = 'no-sound.ogg',
    --[CHAR_SOUND_PANTING] = 'lucas-panting.ogg',
    ...
    [CHAR_SOUND_SNORING1] = 'lucas-inhale.ogg',
    [CHAR_SOUND_SNORING2] = 'lucas-exhale.ogg',
    [CHAR_SOUND_SNORING3] = 'lucas-sleeptalk.ogg',
    [CHAR_SOUND_SO_LONGA_BOWSER] = 'lucas-bowser.ogg',
    [CHAR_SOUND_TWIRL_BOUNCE] = 'lucas-boing.ogg',
    [CHAR_SOUND_UH] = 'lucas-uh.ogg',
    [CHAR_SOUND_UH2] = 'lucas-uh2.ogg',
    [CHAR_SOUND_UH2_2] = 'lucas-uh3.ogg',
    [CHAR_SOUND_WAAAOOOW] = 'lucas-scream.ogg',
    [CHAR_SOUND_WAH2] = 'lucas-jump-wah.ogg',
    [CHAR_SOUND_WHOA] = 'lucas-whoa.ogg',
    [CHAR_SOUND_YAHOO] = 'lucas-yahoo.ogg',
    [CHAR_SOUND_YAHOO_WAHA_YIPPEE] = {'lucas-jump-yahoo.ogg', 'lucas-waha.ogg', 'lucas-yippee.ogg'},
    [CHAR_SOUND_YAH_WAH_HOO] = {'lucas-jump-yah.ogg', 'lucas-jump-wah.ogg', 'lucas-jump-hoo'},
    [CHAR_SOUND_YAWNING] = 'lucas-yawn.ogg',
}
