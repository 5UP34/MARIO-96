...
local VOICETABLE_LUCAS = {
	...
	[CHAR_SOUND_YAH_WAH_HOO] =       {'lucas-jump-yah.ogg', 'lucas-jump-wah.ogg', 'lucas-jump-hoo'}, -- First Jump Sounds
...
local VOICETABLE_FH = {
	...
	[CHAR_SOUND_YAH_WAH_HOO] =       {'fh-yah.ogg', 'fh-wah.ogg', 'fh-hoo'},
...
local ANIMS_MX = {
	...
	[CHAR_ANIM_IDLE_HEAD_CENTER] = MX_ANIM_IDLE,
        ...
        [CHAR_ANIM_TRIPLE_JUMP] = MX_ANIM_TRIPLE_JUMP,
        [CHAR_ANIM_TRIPLE_JUMP_LAND] = MX_ANIM_TRIPLE_JUMP_LAND
}
