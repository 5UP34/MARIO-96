...
local ANIMS_LUCAS = {
	...
	[CHAR_ANIM_LAND_FROM_SINGLE_JUMP] = LUCAS_ANIM_JUMP_LAND
}
...
local ANIMS_FH = {
	...
	[CHAR_ANIM_LAND_FROM_SINGLE_JUMP] = FH_ANIM_JUMP_LAND
}
...
local ANIMS_PC = {
	...
	[CHAR_ANIM_LAND_FROM_SINGLE_JUMP] = PC_ANIM_JUMP_LAND
}
